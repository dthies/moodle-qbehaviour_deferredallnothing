...
/**
 * Unit tests for the deferred all or nothinng feedback behaviour.
 *
...
final class walkthrough_test extends \qbehaviour_walkthrough_test_base {
    public function test_deferredallnothing_feedback_truefalse(): void {

        // Create a true-false question with correct answer true.
        $tf = \test_question_maker::make_question('truefalse', 'true');
        $this->start_attempt_at_question($tf, 'deferredallnothing', 2);
        ...
        $this->process_submission(['answer' => 1]);
    ...
    public function test_deferredallnothing_feedback_multichoice_single(): void {

        // Create a true-false question with correct answer true.
        $mc = \test_question_maker::make_a_multichoice_single_question();
        $this->start_attempt_at_question($mc, 'deferredallnothing', 3);
    ...
    public function test_deferredallnothing_resume_multichoice_single(): void {
        ...
        // Reinitialise.
        $this->setUp();
        $this->quba->set_preferred_behaviour('deferredallnothing');
